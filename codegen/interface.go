...
func (i *isignature) AddParameter(name, typ any) *isignature {
	i.parameters.append(field(name, typ, " ", nil))
	return i
}

func (i *isignature) AddResult(name, typ any) *isignature {
...
func (i *iinterface) AddLineComment(content string, args ...any) *iinterface {
