...
func (i *iif) AddBody(node ...any) *iif {
	i.body.append(node...)
	return i
}
...
func (i *ifor) AddBody(node ...any) *ifor {
	i.body.append(node...)
	return i
}
...
func (i *icase) AddBody(node ...any) *icase {
	i.body.append(node...)
	return i
}
