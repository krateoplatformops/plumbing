...
func (i *ifunction) WithReceiver(name, typ any) *ifunction {
	i.receiver = field(name, typ, " ", nil)
	return i
}

func (i *ifunction) WithCall(params ...any) *ifunction {
	i.call = Call("").AddParameter(params...)
	return i
}

func (i *ifunction) AddParameter(name, typ any) *ifunction {
	i.parameters.append(field(name, typ, " ", nil))
	return i
}

func (i *ifunction) AddResult(name, typ any) *ifunction {
	i.results.append(field(name, typ, " ", nil))
	return i
}

func (i *ifunction) AddBody(node ...any) *ifunction {
	i.body.append(node...)
	return i
}
